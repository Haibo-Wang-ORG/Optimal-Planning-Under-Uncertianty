    ...
    TreeDepth(0)
{
    ...
    /* Sample all particles the initial belief (initial state distribution) */
...
/**
 * Initialize a new VNode and possibly QNodes for each of its children
 * Depends on the input state and the available LEGAL or PREFERRABLE actions
 */
